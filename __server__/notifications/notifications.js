...
const mockNotifications = (quantity) =>
  Array(quantity)
    .fill(0)
    .map(() => ({
      _id: genId(),
      ...
      title: [
        ...
        {en: 'Notification', it: 'Notifica'},
        {en: 'Scheduled meeting', it: 'Appuntamento schedulato'},
      ][randomNumber(0, 4)],
...
class AllNotifications {
  ...
  constructor(quantity, unread) {
    ...
    this.notifications.sort(
      ({createdAt: a}, {createdAt: b}) => -oldestFirst(a, b)
    )
